...
public class GetStudentFromStudentsOfParentStepDefinition {
  ...
  public void the_parent_attempts_to_get_all_students_from_a_parent_with_email_p3(String string) {
    // Write code here that turns the phrase above into concrete actions
    throw new io.cucumber.java.PendingException();
  }
  ...
  public void the_number_of_student_entities_in_the_system_shall_be_p3(String string) {
    // Write code here that turns the phrase above into concrete actions
    throw new io.cucumber.java.PendingException();
  }

  @Then("the number of student entities for parent {string} in the system shall be {string} \\(p3)")
  public void the_number_of_student_entities_for_parent_in_the_system_shall_be_p3(String string,
      String string2) {
    // Write code here that turns the phrase above into concrete actions
    throw new io.cucumber.java.PendingException();
  }
