...
public class GetParentStepDefinitions {
  ...
  public void the_school_admin_attempts_to_get_from_the_system_the_parent_with_email_p8(
    ...
    actualParents = (List<TOParent>) CoolSuppliesFeatureSet1Controller.getParent(string);
  }
  ...
  public void the_school_admin_attempts_to_get_from_the_system_all_the_parents_p8() {
    // Write code here that turns the phrase above into concrete actions
    actualParents = CoolSuppliesFeatureSet1Controller.getParents();
  }

  @Then("the number of parent entities in the system shall be {int} (p8)")
  public void the_number_of_parent_entities_in_the_system_shall_be_p8(int num) {
    // Write code here that turns the phrase above into concrete actions
    assertEquals(num,actualParents.size());
  }
